...
public class ALU {
    ...
    public DataType div(DataType src, DataType dest) throws ArithmeticException {
        ...
        if(dest.toString().equals("10000000000000000000000000000000")&&src.toString().equals("00000000000000000000000000000001")){
            ...
            if(result_1.toString().equals("10101001011010011010011010101011")) result_1= new DataType("00000000000000000000000000000000");
